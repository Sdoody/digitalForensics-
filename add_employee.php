...
<?php
    ...
    if (!$EmployeeID || !$Fname || !$Lname || !$DepartmentID || !$PhoneNumber) {
    ...
    $stmt->bind_param("sssss", $EmployeeID, $Fname, $Lname, $DepartmentID, $PhoneNumber);
    $stmt->execute();
    echo $stmt->affected_rows," Employee has been added!";
